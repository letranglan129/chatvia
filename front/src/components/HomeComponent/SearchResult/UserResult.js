...
function User({ friend }) {
    ...
    return (
        <>
            <div className="flex items-center px-4 py-2 select-none rounded-lg cursor-pointer">
                <img
                    ...
                    {
                        {
                            REVOKE: (
                                <ButtonCircle
                                    clickFunc={handleRevokeAddFriend}
